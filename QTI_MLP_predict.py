...
# noise added:
nii_path = [\
            '/Volumes/Maxtor/ML_TS/P11/High_Res_exp/2_2/og_NII_sub_min_noisy_std_8_dn_db_dg_tp_mc_b0_avg.nii.gz',\
            '/Volumes/Maxtor/ML_TS/P11/High_Res_exp/2_0/og_NII_sub_min_noisy_std_13_dn_db_dg_tp_mc_b0_avg.nii.gz',\
            '/Volumes/Maxtor/ML_TS/P11/High_Res_exp/1_8/og_NII_sub_min_noisy_std_19_dn_db_dg_tp_mc_b0_avg.nii.gz',\
            '/Volumes/Maxtor/ML_TS/P11/High_Res_exp/1_6/og_NII_sub_min_noisy_std_29_dn_db_dg_tp_mc_b0_avg.nii.gz',\
            '/Volumes/Maxtor/ML_TS/P11/High_Res_exp/1_4/og_NII_sub_min_noisy_std_44_dn_db_dg_tp_mc_b0_avg.nii.gz',\
            '/Volumes/Maxtor/ML_TS/P11/High_Res_exp/1_2/og_NII_sub_min_noisy_std_72_dn_db_dg_tp_mc_b0_avg.nii.gz'
            ]
...
# output paths:
# hyperparams:
results_path = '/Users/olivergoedicke/Documents/Uni/PhD/Results/QTI_ML/fit_results/QTI_MLP'
out_dir = 'High_Res_Noise_Sim'
#-------------------------------------------------------------------------------------
# hyperparams:
